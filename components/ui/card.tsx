...
export const Card = ({ className, children, ...props }: HTMLAttributes<HTMLDivElement>) => (
    <div className={cn('sm:rounded-3xl bg-slate-50/88 dark:bg-white/[0.04] border border-slate-200/65 dark:border-white/[0.06] p-3 sm:p-4 shadow-[0_16px_42px_-38px_rgba(15,23,42,0.32)] dark:shadow-none backdrop-blur-sm', className)} {...props}>
        {children}
    </div>
);
