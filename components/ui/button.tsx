...
const buttonStyles = cva(
    'inline-flex min-w-0 max-w-full items-center justify-center rounded-lg text-center font-medium leading-tight transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/35 focus-visible:ring-offset-2 focus-visible:ring-offset-light-bg dark:focus-visible:ring-blue-400/40 dark:focus-visible:ring-offset-night disabled:pointer-events-none disabled:opacity-40 active:translate-y-px [&>svg]:shrink-0',
    {
        variants: {
            variant: {
