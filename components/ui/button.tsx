...
const buttonStyles = cva(
    'inline-flex items-center justify-center rounded-2xl font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber/50 focus-visible:ring-offset-1 focus-visible:ring-offset-light-bg dark:focus-visible:ring-offset-night disabled:opacity-40 disabled:pointer-events-none active:scale-[0.985]',
    {
        variants: {
            variant: {
                primary: 'bg-slate-900 text-white shadow-[0_16px_30px_-18px_rgba(15,23,42,0.72)] hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100',
                secondary: 'border border-slate-200/80 bg-white text-slate-700 shadow-[0_10px_26px_-20px_rgba(15,23,42,0.3)] hover:border-slate-300 hover:bg-slate-50 dark:border-white/[0.07] dark:bg-white/[0.05] dark:text-white/90 dark:hover:bg-white/[0.1]',
